...
class KillerStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      key: globalKey,
      decoration: AppSettings.useNewStyle? const BoxDecoration(
          image: DecorationImage(
              image: AssetImage('assets/images/notepad_bottom.png'),
              fit: BoxFit.fitWidth,
              alignment: AlignmentGeometry.topCenter)):const BoxDecoration(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: RichTextBuilder([
                              ...
                              TextBuilder(
                                  controller.motivation.title(context)),
                            ]).build(),
                          )
                        ],
                      ),
